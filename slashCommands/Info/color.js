  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:905708227998670868> **Name**', json.name, true)
        .addField("<:arrow:905708227998670868> **Hex**", json.hex, true)
        .addField("<:arrow:905708227998670868> **RGB**", json.rgb, true)
        .addField(`<:arrow:905708227998670868> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
