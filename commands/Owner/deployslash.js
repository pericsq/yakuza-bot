...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if (message.author.id != "754977956316577802", "481701586360598538", "467067432033452073")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Fane,PericolRPG and NoCheats is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://easy-code.ro/discord), open a Ticket and ask for it!`)
        ]
      });
    try {
