...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    //only allow the Server owner, (&Fane) to execute this Command, (Fane just because if he needs to help for Shop Bots)
    if(message.author.id != message.guild.ownerId){
      if(message.author.id != "754977956316577802" && message.author.id != "481701586360598538")
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://easy-code.ro')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:success:902091899802910760> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://easy-code.ro')
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:Leave:902086070169124875> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substring(0, 2048))
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://easy-code.ro')
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<a:Error:902091954425298956> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<a:success:902091899802910760> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
            ...
            for(const ch of channels.map(this_Code_is_by_Fane_6966 => this_Code_is_by_Fane_6966)){
              try {
                if(ch) {
