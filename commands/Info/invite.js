  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(user) {
        ...
        let button_invite = new MessageButton().setStyle('LINK').setLabel("Invite " + user.username).setURL(`https://discord.com/api/oauth2/authorize?client_id=932419023176618034&permissions=8&scope=bot`)
        ...
        message.reply({ 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by Easy Code`))],
