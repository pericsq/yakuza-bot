      ...
      if (customavatar) {
        let embed = new Discord.MessageEmbed()
          .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
            usertag: user.tag
          }), customavatar, "https://easy-code.ro")
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .addField("<:arrow:905708227998670868> PNG", `[\`LINK\`](${customavatar})`, true)
          .addField("<:arrow:905708227998670868> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
          .addField("<:arrow:905708227998670868> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
          .setURL(customavatar)
        ...
        let embed = new MessageEmbed()
          ...
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .addField("<:arrow:905708227998670868> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
          .addField("<:arrow:905708227998670868> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
          .addField("<:arrow:905708227998670868> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
