      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<a:Error:902091954425298956> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by Easy Code | https://github?.com/Easy Code/discord-js-lavalink-Music-Bot-erela-js
* @INFO
