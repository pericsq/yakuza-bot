  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<a:neige:939814994328043540> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:Joined:902086085130223657> ${invites} Joins | <:Leave:902086070169124875> ${leaves} Leaves | <a:Error:902091954425298956> ${fake} Fakes]`;
      } 
      else if(invite){
